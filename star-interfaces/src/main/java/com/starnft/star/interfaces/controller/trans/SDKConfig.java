...
public class SDKConfig {
	...
	/** 配置文件中的商户私钥证书路径常量. */
	public static final String SDK_SIGN_CERT_PATH = "sand.ceas.sdk.merchant.cert.path";
	/** 配置文件中的商户私钥证书密码常量. */
	public static final String SDK_SIGN_CERT_PWD = "sand.ceas.sdk.merchant.cert.pwd";
	/** 配置文件中的杉德证书路径常量. */
