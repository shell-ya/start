...
public class TiChainServerTest {
    ...
    public  void goodspush(){
        ...
        int nums=800;
        long prifix=202208018000L;
        for (int i = 1; i <= nums; i++) {
            ids.add(String.format("%s",prifix+i));
        }
        map.put("images","https://banner-1302318928.cos.ap-shanghai.myqcloud.com/theme/1660798662350_1f6dd773.png");
        ...
        publishGoodsReq.setName("链元文创-Pluviophile 首发-射手座");
