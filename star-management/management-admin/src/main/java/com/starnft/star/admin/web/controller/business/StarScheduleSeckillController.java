...
import com.starnft.star.business.domain.vo.SecKillTakeVo;
...
public class StarScheduleSeckillController extends BaseController {
    ...
    public AjaxResult takeDown(@RequestBody SecKillTakeVo takeVo) {
        return AjaxResult.success(starScheduleSeckillService.takeDownStock(Long.parseLong(takeVo.getId()), takeVo.getDownType()));
    }
}
