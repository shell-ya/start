...
public class StarNftThemeNumberVo extends BaseEntity
{
...
//    @Excel(name = "主题信息id")
    ...
    private String seriesThemeName;
...
//            ,converter = DeleteConverter.class)
    ...
    public String getSeriesThemeName() {
        return seriesThemeName;
    }

    public void setSeriesThemeName(String seriesThemeName) {
        this.seriesThemeName = seriesThemeName;
    }
