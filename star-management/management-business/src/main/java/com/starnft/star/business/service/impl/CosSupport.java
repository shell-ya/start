...
public class CosSupport extends ApiKeyConfig implements ICosSupport {
    ...
    @Resource
    private StarNftDictServiceImpl dictManger;
    ...
    public Bucket createBucket(String bucketPrefix, String path, COSClient client) {
        ...
        try {
            ...
            if (!saveBucketMapping(bucketPrefix, path)) {
                throw new ServiceException("桶映射字典插入失败！");
            }
        } catch (CosClientException | ServiceException serverException) {
