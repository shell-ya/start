...
public class SnowflakeWorker {
    ...
    public static Long generateId(){
        SnowflakeWorker idWorker = new SnowflakeWorker(generateSecureRandom(31) , generateSecureRandom(31));
        ...
        try {
            ...
            if (null == network) {
                ...
                if (null != hardwareAddress) {
                    id = (255L & hardwareAddress[hardwareAddress.length - 1] | 65280L & hardwareAddress[hardwareAddress.length - 2] << 8) >>6;
    ...
    public static int generateSecureRandom(int bound){
